                ...
                <div class="container">
                    ...
                    <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
                        <div class="col-20 mx-auto">
                            <div class="card mt-auto border-primary my-5">
                                <div class="card-body">
                                        ...
                                        <div class="form-body mt-4">
                                            ...
                                            <form class="row g-3" action="{{ route('auth') }}" method="POST">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <input type="text" class="form-control border border-dark" id="username" placeholder="Masukan Nama Pengguna" required name="username">
                                                </div>
                                                <div class="col-12">
                                                    <label for="inputChoosePassword" class="form-label">Kata Sandi</label>
                                                    <div class="input-group" id="showHide">
                                                        <input type="password" class="form-control border border-dark" id="password" placeholder="Masukan Kata Sandi" required name="password">
