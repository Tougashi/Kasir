 ...
 <body style="overflow: hidden">
     <div class="wrapper">
         <div class="section-authentication-signin d-flex justify-content-center align-items-center">
             <div class="container">
                             ...
                             <div class="card-body">
                                 <div class="p-4 rounded">
                                     <div class="text-center">
                                         <img src="/assets/image/logo-text.png" alt="Kasir" width="300"
                                         ...
                                         <form class="row g-3" action="{{ route('auth') }}" method="POST">
                                             ...
                                             <div class="col-12">
                                                 ...
                                                 <input type="text" class="form-control border border-dark"
                                                     id="username" placeholder="Masukan Nama Pengguna" name="username">
                                             </div>
                                             <div class="col-12">
                                                 ...
                                                 <div class="input-group" id="showHide">
                                                     <input type="password" class="form-control border border-dark"
                                                         ...
                                                         name="password">
                                                     <a href="#"
                                                         class="input-group-text bg-transparent border border-dark"><i
                                                             class='bx bx-hide'></i></a>
                                                 </div>
                                             </div>
                                             <div class="col-md-6"><a href="#" class="text-success">Lupa Kata
                                                     Sandi?</a></div>
