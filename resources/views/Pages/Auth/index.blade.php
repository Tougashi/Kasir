 ...
 <body style="">
     <div class="wrapperd-flex justify-content-center align-items-center overflow-x-hidden">
                         ...
                         <div class="card-body">
                             <div class="p-4">
                                 <div class="text-center">
                                     <img src="/assets/images/logo-text2.png" alt="Kasir" width="300"
                                 ...
                                 <div class="form-body mt-4">
                                     ...
                                     <form class="row g-3" action="{{ route('auth') }}" method="POST">
                                         ...
                                         <div class="col-12">
                                             ...
                                             <input type="text"
                                                 class="form-control {{ session('username') ? 'is-invalid' : 'border-primary' }}"
                                                 id="username" placeholder="Masukan Nama Pengguna" required
                                         ...
                                         <div class="col-12">
                                             ...
                                             <div class="input-group" id="showHide">
                                                 <input type="password" class="form-control  border border-primary"
                                                     id="password" placeholder="Masukan Kata Sandi" required
                                                     name="password">
                                                 <a href="#"
                                                     class="input-group-text bg-transparent border border-primary"><i
                                         ...
                                         <div class="col-12">
                                             <div class="d-grid">
                                                 <button type="submit" class="btn text-white bg-primary"><i
     ...
     <footer class="bg-primary shadow-sm border-top border-2 p-2 fixed-bottom">
         <p class="mb-0 footer text-light text-center">© KOPERASI SISWA SMKN 2 TASIKMALAYA</p>
     </footer>
     {{-- HIDE & SHOW PASSWORD --}}
     <script>
